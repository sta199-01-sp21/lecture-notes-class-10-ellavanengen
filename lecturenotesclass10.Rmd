...
Very close due to the law of large numbers.
...
```{r simulate_rolls}
simulation <- tibble(
  dice1 = replicate(n=10000, expr = sample(1:6, size=1)),
  dice2 = replicate(n=10000, expr = sample(1:6, size=1))
)
```

```{r identify_events}
simulation <- simulation %>%
  mutate(roll1 = dice1 ^ 2 == dice2,
         roll2 = abs(dice1 - dice2) == 4)
simulation
